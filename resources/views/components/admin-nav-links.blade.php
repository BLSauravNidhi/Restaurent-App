<div id="navigationbar" class=" w-full">
    ...
    <div class=" w-full my-5 ">
        ...
        <div class="flex flex-col text-sm lexend font-medium gap-1">
            <button class=" {{ (request()->routeIs('manage-worker.index') || request()->routeIs('staffPriviledges')) ? 'current-tab' : ''}} dropdown-btn outline-0 fill-gray-500 text-left py-2 px-4 rounded-md text-gray-500 flex flex-row flex-nowrap gap-2 items-center">
